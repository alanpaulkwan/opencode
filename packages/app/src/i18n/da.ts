export const dict = {
  ...
  "session.new.workspace.local.description": "Brug det aktuelle checkout",
  "session.new.workspace.new.description": "Arbejd parallelt",
  "session.new.workspace.existing.description": "Vælg blandt eksisterende arbejdsområder",
  "session.new.workspace.local.tooltip": "Sessionen kører i din projektmappe",
  "session.new.workspace.new.tooltip": "Opretter en isoleret kopi af dit aktuelle checkout",
  "session.new.workspace.existing.tooltip": "Genbrug et eksisterende isoleret arbejdsområde",
  "session.new.workspace.trigger.tooltip": "Vælg, hvor sessionen skal køre",
  "session.new.workspace.search.placeholder": "Søg i arbejdsområder",
  "settings.tab.workspaces": "Arbejdsområder",
  ...
  "settings.workspaces.lastActive": "Senest aktiv: {{time}}",
  "settings.workspaces.lastActiveSession": "Senest aktive session",
  "settings.workspaces.deleteAll": "Slet alle arbejdsområder",
  "settings.workspaces.deleteAll.confirm": "Slet alle {{count}} arbejdsområder?",
  "settings.workspaces.delete.warning":
    "Arbejdsområdets mappe og gren fjernes permanent. Sletning fortsætter kun, hvis det er rent, inaktivt og ikke har tilknyttede sessioner.",
  "settings.workspaces.deleteAll.warning":
    "De {{count}} valgte arbejdsområder i {{project}} fjernes permanent, men kun hvis hvert område er rent, inaktivt og ikke har tilknyttede sessioner.",
  "settings.workspaces.delete.blocked.active": "Det aktive arbejdsområde kan ikke slettes.",
  "settings.workspaces.delete.blocked.linked": "Dette arbejdsområde har tilknyttede sessioner og kan ikke slettes.",
  "settings.workspaces.section.defaults": "Nye sessioner",
  "settings.workspaces.default.title": "Standardmiljø",
  "settings.workspaces.default.description": "Vælg, hvor nye sessioner starter",
  "settings.workspaces.default.lastUsed": "Senest brugt pr. projekt",
  "settings.workspaces.default.local": "Lokal mappe",
  "settings.workspaces.default.new": "Nyt arbejdsområde",
