export const dict = {
  ...
  "session.new.workspace.local.description": "استخدام نسخة العمل الحالية",
  "session.new.workspace.new.description": "العمل بالتوازي",
  "session.new.workspace.existing.description": "الاختيار من مساحات العمل الموجودة",
  "session.new.workspace.local.tooltip": "تعمل الجلسة في مجلد مشروعك",
  "session.new.workspace.new.tooltip": "ينشئ نسخة معزولة من نسخة العمل الحالية لديك",
  "session.new.workspace.existing.tooltip": "إعادة استخدام مساحة عمل معزولة موجودة",
  "session.new.workspace.trigger.tooltip": "تحديد مكان تشغيل الجلسة",
  ...
  "settings.workspaces.lastActive": "آخر نشاط: {{time}}",
  ...
  "settings.workspaces.delete.warning":
    "سيتم حذف دليل مساحة العمل والفرع نهائيًا. لن تتم المتابعة إلا إذا كانت نظيفة وغير نشطة ولا تحتوي على جلسات مرتبطة.",
  "settings.workspaces.deleteAll.warning":
    "سيتم حذف مساحات العمل المحددة وعددها {{count}} في {{project}} نهائيًا فقط إذا كانت كل واحدة نظيفة وغير نشطة ولا تحتوي على جلسات مرتبطة.",
  "settings.workspaces.delete.blocked.active": "لا يمكن حذف مساحة العمل النشطة.",
  "settings.workspaces.delete.blocked.linked": "تحتوي مساحة العمل هذه على جلسات مرتبطة ولا يمكن حذفها.",
  "settings.workspaces.section.defaults": "الجلسات الجديدة",
  "settings.workspaces.default.title": "البيئة الافتراضية",
  "settings.workspaces.default.description": "اختر مكان بدء الجلسات الجديدة",
  "settings.workspaces.default.lastUsed": "آخر بيئة مستخدمة لكل مشروع",
