export const dict = {
  ...
  "command.workspaceTerminal.open": "فتح طرفية مساحة العمل",
  "command.workspaceTerminal.open.description": "فتح الطرفية في علامة تبويب مساحة العمل",
  ...
  "prompt.toast.voice.empty.title": "لم يتم اكتشاف كلام",
  ...
  "home.sessions.group.attention": "تحتاج انتباهاً",
  ...
  "home.sessions.stop": "Stop session",
  "home.sessions.stopped": "Session stopped",
  "home.sessions.cluster.collapse": "Collapse {{name}}",
  "home.sessions.cluster.expand": "Expand {{name}}",
  "home.sessions.namedGroup.ungrouped": "Ungrouped",
  "home.sessions.namedGroup.new": "New group",
  "home.sessions.namedGroup.name": "Group name",
  "home.sessions.namedGroup.rename": "Rename group",
  "home.sessions.namedGroup.rename.description": "Choose a name for this group",
  "home.sessions.namedGroup.create.description": "Name a group for these sessions",
  "home.sessions.namedGroup.move": "Move to group",
  "home.sessions.namedGroup.move.description": "Choose a group for this session",
  "home.sessions.namedGroup.remove": "Remove from group",
  "home.sessions.namedGroup.delete": "Delete group",
  "home.sessions.namedGroup.delete.confirm": "Sessions in {{name}} will move to Ungrouped.",
  "home.sessions.namedGroup.nameThis": "Name this group",
}
