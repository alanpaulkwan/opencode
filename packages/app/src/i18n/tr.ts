...
export const dict = {
  ...
  "session.new.workspace.local.description": "Mevcut çalışma kopyasını kullan",
  "session.new.workspace.new.description": "Paralel çalış",
  "session.new.workspace.existing.description": "Mevcut bir çalışma alanını seç",
  "session.new.workspace.local.tooltip": "Oturum proje klasörünüzde çalışır",
  "session.new.workspace.new.tooltip": "Mevcut çalışma kopyanızdan yalıtılmış bir kopya oluşturur",
  "session.new.workspace.existing.tooltip": "Mevcut yalıtılmış bir çalışma alanını yeniden kullan",
  "session.new.workspace.trigger.tooltip": "Oturumun nerede çalıştırılacağını seç",
  "session.new.workspace.search.placeholder": "Çalışma alanlarında ara",
  ...
  "settings.workspaces.lastActive": "Son etkinlik: {{time}}",
  ...
  "settings.workspaces.delete.warning":
    "Çalışma alanı dizini ve dalı kalıcı olarak kaldırılacak. Silme yalnızca alan temiz, etkin değil ve bağlantılı oturumu yoksa devam eder.",
  "settings.workspaces.deleteAll.warning":
    "{{project}} içindeki seçili {{count}} çalışma alanı, yalnızca her biri temiz, etkin değil ve bağlantılı oturumu yoksa kalıcı olarak kaldırılacak.",
  "settings.workspaces.delete.blocked.active": "Etkin çalışma alanı silinemez.",
  "settings.workspaces.delete.blocked.linked": "Bu çalışma alanında bağlantılı oturumlar var ve silinemez.",
  "settings.workspaces.section.defaults": "Yeni oturumlar",
