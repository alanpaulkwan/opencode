export const dict = {
  ...
  "session.new.workspace.local.description": "ใช้ checkout ปัจจุบัน",
  "session.new.workspace.new.description": "ทำงานแบบคู่ขนาน",
  "session.new.workspace.existing.description": "เลือกพื้นที่ทำงานที่มีอยู่",
  "session.new.workspace.local.tooltip": "เซสชันทำงานในโฟลเดอร์โปรเจกต์ของคุณ",
  "session.new.workspace.new.tooltip": "สร้างสำเนาที่แยกออกมาจาก checkout ปัจจุบันของคุณ",
  "session.new.workspace.existing.tooltip": "นำพื้นที่ทำงานที่แยกไว้แล้วกลับมาใช้",
  ...
  "settings.workspaces.filter.all": "โปรเจกต์ทั้งหมด",
  ...
  "settings.workspaces.lastActive": "ใช้งานล่าสุด: {{time}}",
  ...
  "settings.workspaces.delete.warning":
    "ไดเรกทอรีและสาขาของพื้นที่ทำงานจะถูกลบอย่างถาวร การลบจะดำเนินการต่อเมื่อพื้นที่ทำงานสะอาด ไม่ได้ใช้งาน และไม่มีเซสชันที่เชื่อมโยงเท่านั้น",
  "settings.workspaces.deleteAll.warning":
    "พื้นที่ทำงานที่เลือก {{count}} รายการใน {{project}} จะถูกลบอย่างถาวรเมื่อแต่ละรายการสะอาด ไม่ได้ใช้งาน และไม่มีเซสชันที่เชื่อมโยงเท่านั้น",
  "settings.workspaces.delete.blocked.active": "ไม่สามารถลบพื้นที่ทำงานที่กำลังใช้งานอยู่ได้",
  "settings.workspaces.delete.blocked.linked": "พื้นที่ทำงานนี้มีเซสชันที่เชื่อมโยงอยู่และไม่สามารถลบได้",
  "settings.workspaces.section.defaults": "เซสชันใหม่",
  ...
  "settings.workspaces.default.lastUsed": "ใช้ล่าสุดในแต่ละโปรเจกต์",
  "settings.workspaces.default.local": "ไดเรกทอรีในเครื่อง",
  "settings.workspaces.default.new": "เวิร์กสเปซใหม่",
