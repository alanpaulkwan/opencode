export const dict = {
  ...
  "session.new.workspace.local.description": "Użyj bieżącego checkoutu",
  "session.new.workspace.new.description": "Pracuj równolegle",
  "session.new.workspace.existing.description": "Wybierz istniejącą przestrzeń roboczą",
  "session.new.workspace.local.tooltip": "Sesja działa w folderze Twojego projektu",
  "session.new.workspace.new.tooltip": "Tworzy izolowaną kopię bieżącego checkoutu",
  "session.new.workspace.existing.tooltip": "Użyj ponownie istniejącej izolowanej przestrzeni roboczej",
  "session.new.workspace.trigger.tooltip": "Wybierz, gdzie uruchomić sesję",
  "session.new.workspace.search.placeholder": "Szukaj przestrzeni roboczych",
  ...
  "settings.workspaces.lastActive": "Ostatnia aktywność: {{time}}",
  ...
  "settings.workspaces.delete.warning":
    "Katalog i gałąź obszaru roboczego zostaną trwale usunięte. Usuwanie nastąpi tylko wtedy, gdy obszar jest czysty, nieaktywny i nie ma powiązanych sesji.",
  "settings.workspaces.deleteAll.warning":
    "Wybrane obszary robocze ({{count}}) w {{project}} zostaną trwale usunięte tylko wtedy, gdy każdy jest czysty, nieaktywny i nie ma powiązanych sesji.",
  "settings.workspaces.delete.blocked.active": "Nie można usunąć aktywnego obszaru roboczego.",
  "settings.workspaces.delete.blocked.linked": "Ten obszar roboczy ma powiązane sesje i nie można go usunąć.",
  "settings.workspaces.section.defaults": "Nowe sesje",
  "settings.workspaces.default.title": "Domyślne środowisko",
  "settings.workspaces.default.description": "Wybierz, gdzie mają się rozpoczynać nowe sesje",
  "settings.workspaces.default.lastUsed": "Ostatnio używane w każdym projekcie",
