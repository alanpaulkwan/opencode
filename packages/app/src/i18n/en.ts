export const dict = {
  ...
  "session.new.workspace.local.description": "Use current checkout",
  "session.new.workspace.new.description": "Work in parallel",
  "session.new.workspace.existing.description": "Pick from existing",
  "session.new.workspace.local.tooltip": "Session runs in your project folder",
  "session.new.workspace.new.tooltip": "Creates an isolated copy from your current checkout",
  "session.new.workspace.existing.tooltip": "Reuse an existing isolated workspace",
  ...
  "settings.workspaces.lastActive": "Last active {{time}}",
  ...
  "settings.workspaces.section.defaults": "New sessions",
