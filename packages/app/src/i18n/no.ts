...
export const dict = {
  ...
  "session.new.workspace.local.description": "Bruk gjeldende checkout",
  "session.new.workspace.new.description": "Arbeid parallelt",
  "session.new.workspace.existing.description": "Velg et eksisterende arbeidsområde",
  "session.new.workspace.local.tooltip": "Sesjonen kjører i prosjektmappen din",
  "session.new.workspace.new.tooltip": "Oppretter en isolert kopi fra checkouten du bruker nå",
  "session.new.workspace.existing.tooltip": "Gjenbruk et eksisterende isolert arbeidsområde",
  "session.new.workspace.trigger.tooltip": "Velg hvor sesjonen skal kjøres",
  ...
  "settings.workspaces.empty": "Ingen arbeidsområder",
  ...
  "settings.workspaces.lastActive": "Sist aktiv: {{time}}",
  "settings.workspaces.lastActiveSession": "Sist aktive økt",
  "settings.workspaces.deleteAll": "Slett alle arbeidsområder",
  "settings.workspaces.deleteAll.confirm": "Slette alle {{count}} arbeidsområder?",
  "settings.workspaces.delete.warning":
    "Arbeidsområdets mappe og gren fjernes permanent. Sletting fortsetter bare hvis det er rent, inaktivt og ikke har tilknyttede økter.",
  "settings.workspaces.deleteAll.warning":
    "De {{count}} valgte arbeidsområdene i {{project}} fjernes permanent bare hvis hvert område er rent, inaktivt og ikke har tilknyttede økter.",
  "settings.workspaces.delete.blocked.active": "Det aktive arbeidsområdet kan ikke slettes.",
  "settings.workspaces.delete.blocked.linked": "Dette arbeidsområdet har tilknyttede økter og kan ikke slettes.",
  "settings.workspaces.section.defaults": "Nye økter",
  "settings.workspaces.default.title": "Standardmiljø",
  ...
  "settings.workspaces.default.local": "Lokal mappe",
  "settings.workspaces.default.new": "Nytt arbeidsområde",
  "workspace.move.title": "Flytt til arbeidsområde",
  "workspace.move.failed": "Kunne ikke flytte økten",
  "workspace.lifecycle.creating": "Oppretter arbeidsområde",
  "workspace.lifecycle.created": "Arbeidsområdet er opprettet",
  "workspace.lifecycle.moving": "Flytter til arbeidsområde",
  "workspace.lifecycle.set": "Arbeidsområdet er angitt",
