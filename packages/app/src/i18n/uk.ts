export const dict = {
  ...
  "common.viewAll": "Показати все",
  "session.new.workspace.fromBranch": "з {{branch}}",
  "session.new.workspace.local.description": "Використати поточну робочу копію",
  "session.new.workspace.new.description": "Працювати паралельно",
  "session.new.workspace.existing.description": "Вибрати наявну робочу область",
  "session.new.workspace.local.tooltip": "Сесія запускається в папці вашого проєкту",
  "session.new.workspace.new.tooltip": "Створює ізольовану копію на основі вашої поточної робочої копії",
  "session.new.workspace.existing.tooltip": "Повторно використати наявну ізольовану робочу область",
  "session.new.workspace.trigger.tooltip": "Вибрати, де запустити сесію",
  "session.new.workspace.search.placeholder": "Пошук робочих областей",
  "settings.tab.workspaces": "Робочі простори",
  ...
  "settings.workspaces.lastActive": "Остання активність: {{time}}",
  "settings.workspaces.lastActiveSession": "Останній активний сеанс",
  "settings.workspaces.deleteAll": "Видалити всі робочі простори",
  "settings.workspaces.deleteAll.confirm": "Видалити всі робочі простори ({{count}})?",
  "settings.workspaces.delete.warning":
    "Каталог і гілку робочого простору буде видалено назавжди. Видалення виконується лише для чистого, неактивного простору без пов’язаних сеансів.",
  "settings.workspaces.deleteAll.warning":
    "Вибрані робочі простори ({{count}}) у {{project}} буде видалено назавжди, лише якщо кожен із них чистий, неактивний і не має пов’язаних сеансів.",
  "settings.workspaces.delete.blocked.active": "Активний робочий простір не можна видалити.",
  "settings.workspaces.delete.blocked.linked": "Цей робочий простір має пов’язані сеанси, тому його не можна видалити.",
  "settings.workspaces.section.defaults": "Нові сеанси",
  "settings.workspaces.default.title": "Середовище за замовчуванням",
  "settings.workspaces.default.description": "Виберіть, де починатимуться нові сеанси",
  "settings.workspaces.default.lastUsed": "Останнє використане для кожного проєкту",
