...
export const dict = {
  ...
  "workspace.new": "新建工作区",
  "common.viewAll": "查看全部",
  "session.new.workspace.fromBranch": "从 {{branch}}",
  "session.new.workspace.local.description": "使用当前工作副本",
  "session.new.workspace.new.description": "并行工作",
  "session.new.workspace.existing.description": "从现有工作区中选择",
  "session.new.workspace.local.tooltip": "会话在你的项目文件夹中运行",
  "session.new.workspace.new.tooltip": "基于你当前的工作副本创建隔离副本",
  "session.new.workspace.existing.tooltip": "复用现有的隔离工作区",
  ...
  "settings.workspaces.lastActive": "上次活跃：{{time}}",
  "settings.workspaces.lastActiveSession": "最近活跃的会话",
  ...
  "settings.workspaces.delete.warning":
    "工作区目录和分支将被永久删除。仅当工作区干净、未处于活动状态且没有关联会话时才会继续删除。",
  "settings.workspaces.deleteAll.warning":
    "仅当 {{project}} 中选定的 {{count}} 个工作区均干净、未处于活动状态且没有关联会话时，才会永久删除它们。",
  "settings.workspaces.delete.blocked.active": "无法删除当前活动的工作区。",
  "settings.workspaces.delete.blocked.linked": "此工作区有关联会话，无法删除。",
  "settings.workspaces.section.defaults": "新会话",
  "settings.workspaces.default.title": "默认环境",
  "settings.workspaces.default.description": "选择新会话的启动位置",
  "settings.workspaces.default.lastUsed": "每个项目上次使用的环境",
  "settings.workspaces.default.local": "本地目录",
  "settings.workspaces.default.new": "新工作区",
