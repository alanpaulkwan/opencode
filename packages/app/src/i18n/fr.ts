export const dict = {
  ...
  "session.new.workspace.fromBranch": "depuis {{branch}}",
  "session.new.workspace.local.description": "Utiliser le checkout actuel",
  "session.new.workspace.new.description": "Travailler en parallèle",
  "session.new.workspace.existing.description": "Choisir un espace de travail existant",
  "session.new.workspace.local.tooltip": "La session s'exécute dans le dossier de votre projet",
  "session.new.workspace.new.tooltip": "Crée une copie isolée à partir de votre checkout actuel",
  "session.new.workspace.existing.tooltip": "Réutiliser un espace de travail isolé existant",
  "session.new.workspace.trigger.tooltip": "Choisir où exécuter la session",
  ...
  "settings.workspaces.lastActive": "Dernière activité : {{time}}",
  ...
  "settings.workspaces.deleteAll.confirm": "Supprimer les {{count}} espaces de travail ?",
  "settings.workspaces.delete.warning":
    "Le dossier et la branche de l’espace de travail seront supprimés définitivement. La suppression ne continue que s’il est propre, inactif et sans session liée.",
  "settings.workspaces.deleteAll.warning":
    "Les {{count}} espaces de travail sélectionnés dans {{project}} seront supprimés définitivement uniquement si chacun est propre, inactif et sans session liée.",
  ...
  "settings.workspaces.delete.blocked.linked":
    "Cet espace de travail contient des sessions liées et ne peut pas être supprimé.",
  "settings.workspaces.section.defaults": "Nouvelles sessions",
  "settings.workspaces.default.title": "Environnement par défaut",
  "settings.workspaces.default.description": "Choisissez où démarrent les nouvelles sessions",
  "settings.workspaces.default.lastUsed": "Dernier utilisé par projet",
