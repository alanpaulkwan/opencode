...
export const dict = {
  ...
  "session.new.workspace.fromBranch": "aus {{branch}}",
  "session.new.workspace.local.description": "Aktuellen Checkout verwenden",
  "session.new.workspace.new.description": "Parallel arbeiten",
  "session.new.workspace.existing.description": "Vorhandenen Arbeitsbereich auswählen",
  "session.new.workspace.local.tooltip": "Die Sitzung läuft in Ihrem Projektverzeichnis",
  "session.new.workspace.new.tooltip": "Erstellt eine isolierte Kopie Ihres aktuellen Checkouts",
  "session.new.workspace.existing.tooltip": "Vorhandenen isolierten Arbeitsbereich wiederverwenden",
  "session.new.workspace.trigger.tooltip": "Auswählen, wo die Sitzung ausgeführt werden soll",
  ...
  "settings.workspaces.lastActive": "Zuletzt aktiv: {{time}}",
  "settings.workspaces.lastActiveSession": "Zuletzt aktive Sitzung",
  "settings.workspaces.deleteAll": "Alle Arbeitsbereiche löschen",
  "settings.workspaces.deleteAll.confirm": "Alle {{count}} Arbeitsbereiche löschen?",
  "settings.workspaces.delete.warning":
    "Verzeichnis und Branch des Arbeitsbereichs werden dauerhaft entfernt. Die Löschung erfolgt nur, wenn er sauber und inaktiv ist und keine verknüpften Sitzungen hat.",
  "settings.workspaces.deleteAll.warning":
    "Die {{count}} ausgewählten Arbeitsbereiche in {{project}} werden nur dauerhaft entfernt, wenn jeder sauber und inaktiv ist und keine verknüpften Sitzungen hat.",
  ...
  "settings.workspaces.delete.blocked.linked":
    "Dieser Arbeitsbereich hat verknüpfte Sitzungen und kann nicht gelöscht werden.",
  "settings.workspaces.section.defaults": "Neue Sitzungen",
  "settings.workspaces.default.title": "Standardumgebung",
  "settings.workspaces.default.description": "Wählen Sie, wo neue Sitzungen starten",
  ...
  "workspace.move.title": "In Arbeitsbereich verschieben",
  "workspace.move.failed": "Sitzung konnte nicht verschoben werden",
  "workspace.lifecycle.creating": "Arbeitsbereich wird erstellt",
  "workspace.lifecycle.created": "Arbeitsbereich erstellt",
  "workspace.lifecycle.moving": "Wird in den Arbeitsbereich verschoben",
  "workspace.lifecycle.set": "Arbeitsbereich festgelegt",
