export const dict = {
  ...
  "session.new.workspace.fromBranch": "desde {{branch}}",
  "session.new.workspace.local.description": "Usar el checkout actual",
  "session.new.workspace.new.description": "Trabajar en paralelo",
  "session.new.workspace.existing.description": "Elegir un espacio de trabajo existente",
  "session.new.workspace.local.tooltip": "La sesión se ejecuta en la carpeta de tu proyecto",
  "session.new.workspace.new.tooltip": "Crea una copia aislada a partir de tu checkout actual",
  "session.new.workspace.existing.tooltip": "Reutilizar un espacio de trabajo aislado existente",
  "session.new.workspace.trigger.tooltip": "Seleccionar dónde ejecutar la sesión",
  ...
  "settings.workspaces.lastActive": "Última actividad: {{time}}",
  ...
  "settings.workspaces.deleteAll.confirm": "¿Eliminar los {{count}} espacios de trabajo?",
  "settings.workspaces.delete.warning":
    "El directorio y la rama del espacio de trabajo se eliminarán permanentemente. La eliminación solo continuará si está limpio, inactivo y no tiene sesiones vinculadas.",
  "settings.workspaces.deleteAll.warning":
    "Los {{count}} espacios de trabajo seleccionados en {{project}} se eliminarán permanentemente solo si cada uno está limpio, inactivo y no tiene sesiones vinculadas.",
  ...
  "settings.workspaces.delete.blocked.linked":
    "Este espacio de trabajo tiene sesiones vinculadas y no se puede eliminar.",
  "settings.workspaces.section.defaults": "Nuevas sesiones",
  "settings.workspaces.default.title": "Entorno predeterminado",
  "settings.workspaces.default.description": "Elige dónde se inician las nuevas sesiones",
  "settings.workspaces.default.lastUsed": "Último usado en cada proyecto",
