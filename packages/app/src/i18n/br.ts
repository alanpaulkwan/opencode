export const dict = {
  ...
  "session.new.workspace.local.description": "Usar o checkout atual",
  "session.new.workspace.new.description": "Trabalhar em paralelo",
  "session.new.workspace.existing.description": "Escolher um espaço de trabalho existente",
  "session.new.workspace.local.tooltip": "A sessão é executada na pasta do seu projeto",
  "session.new.workspace.new.tooltip": "Cria uma cópia isolada a partir do seu checkout atual",
  "session.new.workspace.existing.tooltip": "Reutilizar um espaço de trabalho isolado existente",
  "session.new.workspace.trigger.tooltip": "Selecionar onde executar a sessão",
  ...
  "settings.workspaces.lastActive": "Última atividade: {{time}}",
  ...
  "settings.workspaces.delete.warning":
    "O diretório e a ramificação do espaço de trabalho serão removidos permanentemente. A exclusão só prossegue se ele estiver limpo, inativo e sem sessões vinculadas.",
  "settings.workspaces.deleteAll.warning":
    "Os {{count}} espaços de trabalho selecionados em {{project}} serão removidos permanentemente somente se cada um estiver limpo, inativo e sem sessões vinculadas.",
  ...
  "settings.workspaces.delete.blocked.linked":
    "Este espaço de trabalho tem sessões vinculadas e não pode ser excluído.",
  "settings.workspaces.section.defaults": "Novas sessões",
