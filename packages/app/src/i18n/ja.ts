export const dict = {
  ...
  "session.new.workspace.local.description": "現在のチェックアウトを使用",
  "session.new.workspace.new.description": "並行して作業",
  "session.new.workspace.existing.description": "既存のワークスペースから選択",
  "session.new.workspace.local.tooltip": "セッションはプロジェクトフォルダで実行されます",
  "session.new.workspace.new.tooltip": "現在のチェックアウトから独立したコピーを作成します",
  "session.new.workspace.existing.tooltip": "既存の独立したワークスペースを再利用します",
  "session.new.workspace.trigger.tooltip": "セッションの実行先を選択します",
  ...
  "settings.workspaces.empty": "ワークスペースなし",
  "settings.workspaces.count.one": "{{count}}件のワークスペース",
  "settings.workspaces.count.other": "{{count}}件のワークスペース",
  "settings.workspaces.sessions.one": "{{project}}のセッション{{count}}件",
  "settings.workspaces.sessions.other": "{{project}}のセッション{{count}}件",
  "settings.workspaces.lastActive": "最終アクティブ: {{time}}",
  "settings.workspaces.lastActiveSession": "最後にアクティブだったセッション",
  "settings.workspaces.deleteAll": "すべてのワークスペースを削除",
  "settings.workspaces.deleteAll.confirm": "{{count}}件のワークスペースをすべて削除しますか？",
  "settings.workspaces.delete.warning":
    "ワークスペースのディレクトリとブランチは完全に削除されます。クリーンで非アクティブかつリンクされたセッションがない場合にのみ削除されます。",
  "settings.workspaces.deleteAll.warning":
    "{{project}} で選択された{{count}}件のワークスペースは、それぞれがクリーンで非アクティブかつリンクされたセッションがない場合にのみ完全に削除されます。",
  "settings.workspaces.delete.blocked.active": "アクティブなワークスペースは削除できません。",
  "settings.workspaces.delete.blocked.linked": "このワークスペースにはリンクされたセッションがあるため削除できません。",
  "settings.workspaces.section.defaults": "新しいセッション",
  "settings.workspaces.default.title": "デフォルト環境",
  "settings.workspaces.default.description": "新しいセッションの開始場所を選択します",
  "settings.workspaces.default.lastUsed": "プロジェクトごとに前回使用した環境",
  "settings.workspaces.default.local": "ローカルディレクトリ",
  "settings.workspaces.default.new": "新しいワークスペース",
  "workspace.move.title": "ワークスペースに移動",
  "workspace.move.failed": "セッションを移動できませんでした",
