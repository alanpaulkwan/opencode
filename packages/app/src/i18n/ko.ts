export const dict = {
  ...
  "session.new.workspace.local.description": "현재 체크아웃 사용",
  "session.new.workspace.new.description": "병렬로 작업",
  "session.new.workspace.existing.description": "기존 작업 공간 중에서 선택",
  "session.new.workspace.local.tooltip": "세션은 프로젝트 폴더에서 실행됩니다",
  "session.new.workspace.new.tooltip": "현재 체크아웃을 기반으로 격리된 복사본을 만듭니다",
  "session.new.workspace.existing.tooltip": "기존의 격리된 작업 공간을 재사용합니다",
  "session.new.workspace.trigger.tooltip": "세션을 실행할 위치를 선택하세요",
  ...
  "settings.workspaces.count.one": "작업 공간 {{count}}개",
  "settings.workspaces.count.other": "작업 공간 {{count}}개",
  "settings.workspaces.sessions.one": "{{project}}에 세션 {{count}}개",
  "settings.workspaces.sessions.other": "{{project}}에 세션 {{count}}개",
  "settings.workspaces.lastActive": "마지막 활동: {{time}}",
  "settings.workspaces.lastActiveSession": "마지막 활성 세션",
  "settings.workspaces.deleteAll": "모든 작업 공간 삭제",
  "settings.workspaces.deleteAll.confirm": "작업 공간 {{count}}개를 모두 삭제할까요?",
  "settings.workspaces.delete.warning":
    "작업 공간 디렉터리와 브랜치가 영구적으로 삭제됩니다. 깨끗하고 비활성 상태이며 연결된 세션이 없는 경우에만 삭제됩니다.",
  "settings.workspaces.deleteAll.warning":
    "{{project}}에서 선택한 작업 공간 {{count}}개는 각각 깨끗하고 비활성 상태이며 연결된 세션이 없는 경우에만 영구적으로 삭제됩니다.",
  "settings.workspaces.delete.blocked.active": "활성 작업 공간은 삭제할 수 없습니다.",
  "settings.workspaces.delete.blocked.linked": "이 작업 공간에는 연결된 세션이 있어 삭제할 수 없습니다.",
  "settings.workspaces.section.defaults": "새 세션",
  "settings.workspaces.default.title": "기본 환경",
  "settings.workspaces.default.description": "새 세션을 시작할 위치를 선택하세요",
  "settings.workspaces.default.lastUsed": "프로젝트별 마지막 사용 환경",
  "settings.workspaces.default.local": "로컬 디렉터리",
  "settings.workspaces.default.new": "새 작업 공간",
  "workspace.move.title": "작업 공간으로 이동",
  "workspace.move.failed": "세션을 이동하지 못했습니다",
  "workspace.lifecycle.creating": "작업 공간 생성 중",
  "workspace.lifecycle.created": "작업 공간을 만들었습니다",
  "workspace.lifecycle.moving": "작업 공간으로 이동 중",
  "workspace.lifecycle.set": "작업 공간을 설정했습니다",
