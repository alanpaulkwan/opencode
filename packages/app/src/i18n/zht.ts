...
export const dict = {
  ...
  "workspace.new": "新增工作區",
  "common.viewAll": "查看全部",
  "session.new.workspace.fromBranch": "從 {{branch}}",
  "session.new.workspace.local.description": "使用目前的工作複本",
  "session.new.workspace.new.description": "平行作業",
  "session.new.workspace.existing.description": "從現有工作區中選擇",
  "session.new.workspace.local.tooltip": "工作階段會在你的專案資料夾中執行",
  "session.new.workspace.new.tooltip": "根據你目前的工作複本建立隔離複本",
  "session.new.workspace.existing.tooltip": "重新使用現有的隔離工作區",
  ...
  "settings.workspaces.lastActive": "上次活動：{{time}}",
  "settings.workspaces.lastActiveSession": "最近活動的工作階段",
  ...
  "settings.workspaces.delete.warning":
    "工作區目錄和分支將被永久刪除。只有在工作區乾淨、未處於活動狀態且沒有關聯工作階段時才會繼續刪除。",
  "settings.workspaces.deleteAll.warning":
    "只有在 {{project}} 中選取的 {{count}} 個工作區都乾淨、未處於活動狀態且沒有關聯工作階段時，才會永久刪除它們。",
  "settings.workspaces.delete.blocked.active": "無法刪除目前作用中的工作區。",
  "settings.workspaces.delete.blocked.linked": "此工作區有關聯工作階段，無法刪除。",
  "settings.workspaces.section.defaults": "新工作階段",
  "settings.workspaces.default.title": "預設環境",
  "settings.workspaces.default.description": "選擇新工作階段的啟動位置",
  "settings.workspaces.default.lastUsed": "每個專案上次使用的環境",
  "settings.workspaces.default.local": "本機目錄",
  "settings.workspaces.default.new": "新工作區",
