export const dict = {
  ...
  "session.new.workspace.fromBranch": "iz {{branch}}",
  "session.new.workspace.local.description": "Koristi trenutni checkout",
  "session.new.workspace.new.description": "Radi paralelno",
  "session.new.workspace.existing.description": "Odaberi postojeći radni prostor",
  "session.new.workspace.local.tooltip": "Sesija se pokreće u folderu vašeg projekta",
  "session.new.workspace.new.tooltip": "Kreira izolovanu kopiju vašeg trenutnog checkouta",
  "session.new.workspace.existing.tooltip": "Ponovo koristi postojeći izolovani radni prostor",
  "session.new.workspace.trigger.tooltip": "Odaberi gdje pokrenuti sesiju",
  "session.new.workspace.search.placeholder": "Pretraži radne prostore",
  ...
  "settings.workspaces.lastActive": "Posljednja aktivnost: {{time}}",
  "settings.workspaces.lastActiveSession": "Posljednja aktivna sesija",
  "settings.workspaces.deleteAll": "Izbriši sve radne prostore",
  "settings.workspaces.deleteAll.confirm": "Izbrisati svih {{count}} radnih prostora?",
  "settings.workspaces.delete.warning":
    "Direktorij radnog prostora i grana bit će trajno izbrisani. Brisanje se nastavlja samo ako je radni prostor čist, neaktivan i nema povezanih sesija.",
  "settings.workspaces.deleteAll.warning":
    "Odabranih {{count}} radnih prostora u {{project}} bit će trajno izbrisano samo ako je svaki čist, neaktivan i nema povezanih sesija.",
  "settings.workspaces.delete.blocked.active": "Aktivni radni prostor nije moguće izbrisati.",
  "settings.workspaces.delete.blocked.linked": "Ovaj radni prostor ima povezane sesije i nije ga moguće izbrisati.",
  "settings.workspaces.section.defaults": "Nove sesije",
