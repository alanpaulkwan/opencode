export const dict = {
  ...
  "session.new.workspace.local.description": "Использовать текущую рабочую копию",
  "session.new.workspace.new.description": "Работать параллельно",
  "session.new.workspace.existing.description": "Выбрать существующее рабочее пространство",
  "session.new.workspace.local.tooltip": "Сессия запускается в папке вашего проекта",
  "session.new.workspace.new.tooltip": "Создаёт изолированную копию на основе вашей текущей рабочей копии",
  "session.new.workspace.existing.tooltip": "Повторно использовать существующее изолированное рабочее пространство",
  "session.new.workspace.trigger.tooltip": "Выбрать, где запустить сессию",
  ...
  "settings.workspaces.lastActive": "Последняя активность: {{time}}",
  ...
  "settings.workspaces.delete.warning":
    "Каталог и ветка рабочего пространства будут удалены безвозвратно. Удаление выполняется только для чистого, неактивного пространства без связанных сеансов.",
  "settings.workspaces.deleteAll.warning":
    "Выбранные рабочие пространства ({{count}}) в {{project}} будут удалены безвозвратно, только если каждое из них чистое, неактивное и не имеет связанных сеансов.",
  "settings.workspaces.delete.blocked.active": "Активное рабочее пространство нельзя удалить.",
  "settings.workspaces.delete.blocked.linked":
    "У этого рабочего пространства есть связанные сеансы, поэтому его нельзя удалить.",
  "settings.workspaces.section.defaults": "Новые сеансы",
  "settings.workspaces.default.title": "Среда по умолчанию",
  "settings.workspaces.default.description": "Выберите, где будут запускаться новые сеансы",
  "settings.workspaces.default.lastUsed": "Последняя использованная среда проекта",
